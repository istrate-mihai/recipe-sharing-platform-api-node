...
import { toggle as toggleFavourite } from '../favourites/favourites.controller.js';
import { toggle as toggleLike }      from '../likes/likes.controller.js';
...
router.post('/:id',                   authenticate, uploadImages, update);
router.delete('/:id',                 authenticate, destroy);
router.get('/:id/export-pdf',         authenticate, requirePremium, exportPdf);
router.post('/:recipeId/favourite',   authenticate, toggleFavourite);
